class SupabaseConfig {
  ...
  // Service Role Key (necesaria para auto-configuración de tablas/bucket)
  // Obtén esta clave en: Supabase Dashboard → Project Settings → API → service_role key
  // ⚠️ NUNCA expongas esta clave en apps de cliente (solo para desarrollo/administración)
